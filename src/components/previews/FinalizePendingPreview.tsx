...
/**
 * Confirm Finalized Quote — PENDING state preview content, shared by
 * /admin/previews/finalize-pending and
 * /tms-v2/previews/pages/finalize-pending (retirement-readiness
 * Objective 1D).
 *
 ...
 * state lives in FinalizeConfirmedPreview.tsx.
 *
