...
/**
 * Decline quote — preview-only content, shared by /admin/previews/decline
 * and /tms-v2/previews/pages/decline (retirement-readiness Objective 1D).
 *
 ...
 *
 * `confirmShipmentHref` is the app-specific "Accept and finalize
 * instead" cross-link (was hardcoded to /admin/previews/confirm-shipment
 * before this component was shared with /tms-v2).
 */
...
export default function DeclinePreviewPage({ confirmShipmentHref }: { confirmShipmentHref: string }) {
