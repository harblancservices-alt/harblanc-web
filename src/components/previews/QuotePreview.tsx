...
/**
 * Quick Quote — preview-only content, shared by /admin/previews/quote
 * and /tms-v2/previews/pages/quote (retirement-readiness Objective 1D).
 *
 ...
 *
 * Each app's page.tsx supplies its own admin/auth gate via its layout;
 * this component has none of its own.
 */
