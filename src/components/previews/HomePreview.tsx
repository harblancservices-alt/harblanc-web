...
/**
 * Public landing page — preview-only content, shared by
 * /admin/previews/home and /tms-v2/previews/pages/home
 * (retirement-readiness Objective 1D).
 *
 ...
 * visitor would. The admin/tms-v2 shell above is unavoidable since this
 * lives under an authed layout, but inside the preview iframe the
 * operator focuses on the page body, not the shell wrapping it.
 *
