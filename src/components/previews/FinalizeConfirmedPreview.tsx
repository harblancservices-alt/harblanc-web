...
/**
 * Confirm Finalized Quote — CONFIRMED state preview content, shared by
 * /admin/previews/finalize-confirmed and
 * /tms-v2/previews/pages/finalize-confirmed (retirement-readiness
 * Objective 1D).
 *
 ...
 * matching PENDING state lives in FinalizePendingPreview.tsx.
 */
