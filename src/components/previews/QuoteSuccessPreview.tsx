...
/**
 * Quick Quote success — preview-only content, shared by
 * /admin/previews/quote-success and /tms-v2/previews/pages/quote-success
 * (retirement-readiness Objective 1D). Mirrors /quote/success with a red
 * preview banner at the top.
 */
