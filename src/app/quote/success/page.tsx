...
export const metadata: Metadata = {
  ...
  description:
    "Your freight request reached dispatch. A real dispatcher will reply within the hour.",
 ...
 *
 * Job (per docs/communication-workflow.md):
 *   - confirm the request landed
 *   - set the expectation: response within the hour from a real dispatcher
 *   - keep a direct phone line one tap away for time-critical loads
 *   - DO NOT promise hard pricing or a PDF here — those happen later in
 *     the workflow after engagement
 */
      ...
      <section className="border-b border-neutral-800 bg-neutral-950">
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
          ...
          <div className="mt-8 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center">
            ...
            >
              Call dispatch · {company.dispatchPhone}
            </a>
            <Link
              href="/"
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          ...
          <p className="mt-6 font-mono text-[10px] tracking-[0.18em] text-neutral-500 uppercase">
            Check spam if you don’t see a confirmation email in a few minutes —
            it’s from{" "}
            <a
