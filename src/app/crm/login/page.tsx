      ...
      <div className="w-full max-w-[420px]">
        <div className="mb-7 flex flex-col items-center gap-3 text-center">
          <div className="flex items-center gap-2.5">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#2f76d6] text-[18px] font-black text-white">
              H
            </span>
        ...
        <div className="rounded-2xl border border-[#242b35] bg-[#12161c] p-8 shadow-[0_24px_60px_-20px_rgba(0,0,0,0.7)]">
