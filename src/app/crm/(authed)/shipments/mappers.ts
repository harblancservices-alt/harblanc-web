...
export function mapShipmentRow(row: CrmShipmentRow): CrmShipment {
  return {
    ...
    pickupTimingMode: row.pickup_timing_mode,
    pickupAppointmentTime: row.pickup_appointment_time,
    pickupWindowStart: row.pickup_window_start,
    pickupWindowEnd: row.pickup_window_end,
    deliveryDate: row.delivery_date,
    deliveryTimingMode: row.delivery_timing_mode,
    deliveryAppointmentTime: row.delivery_appointment_time,
