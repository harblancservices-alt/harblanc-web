 ...
 * BolSection carries its own Card chrome (upload/view/download/delete all
 * untouched), commodity photos get a plain labeled block since
...
export function FilesTab({
  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      <BolSection accountId={accountId} orgId={orgId} documents={documents} />
