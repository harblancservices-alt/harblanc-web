...
export function RepControl({
  ...
  return (
    <select
      ...
      className="h-9 rounded-lg border border-line-strong bg-card px-2.5 text-[13px] font-medium text-fg outline-none transition-shadow focus:ring-2 focus:ring-accent/40 disabled:opacity-60"
    >
