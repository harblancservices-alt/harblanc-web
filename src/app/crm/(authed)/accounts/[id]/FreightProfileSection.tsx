...
/**
 * Details tab — "Freight profile" group. Commodities + commodity photos
 * already live on the permanent Company card (see CompanyCard.tsx / the
 * other session's relocation), so this only covers what's still uncaptured:
 * equipment, lanes, volume/frequency, weight range, special requirements.
