...
export default async function TmsV2TodayPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Command-center hero — the one figure that outranks everything else
          on the page (v2-design.md's Today wireframe). */}
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
        {/* Right rail (~30% on desktop): Quick Add + Needs Attention. First
            ...
            there's room for the two-column split.
        ...
        <aside className="flex flex-col gap-6 lg:order-2 lg:w-[340px] lg:shrink-0">
        ...
        {/* Hero workspace region (~70% on desktop): active loads. */}
        <div className="flex min-w-0 flex-1 flex-col gap-2 lg:order-1">
